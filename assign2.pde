 ...
 int soldierY,cabbageX,cabbageY,groundhogIdleX,groundhogIdleY;
...
void draw() {
  ...
  if(upPressed){
     groundhogIdleY -= groundhogIdleSpeed;
       if(groundhogIdleY < 160 )groundhogIdleY = 160 ;
         upPressed = false;
      }
   if(downPressed){
     groundhogIdleY += groundhogIdleSpeed;
       if(groundhogIdleY + groundhogSize > height)groundhogIdleY = 160;
         downPressed = false;
      }
    if(leftPressed){
      groundhogIdleX -= groundhogIdleSpeed;
       if(groundhogIdleX < 0)groundhogIdleX = width - 80;
          leftPressed = false;
      }
    if(rightPressed){
       groundhogIdleX += groundhogIdleSpeed;
       
     if(groundhogIdleX + groundhogSize > width)groundhogIdleX = 0;
        rightPressed = false;
      }
